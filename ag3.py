...
from agst3.androguard.decompiler import decompiler
...
class MethodView:
    def __init__(self, orig_id, method):
        ...
        self.view.set_syntax_file("Packages/agst3/agbytecodes.tmLanguage")
...
class AnalyseAXMLThread:
    ...
    def run(self):
        ...
        edit = self.view.begin_edit()
        self.view.sel().clear()
        #self.view.set_syntax_file("Packages/agst3/agapk.tmLanguage")
...
class AnalyseDexThread:  # (threading.Thread):
    ...
    def run(self):
        ...
        edit = self.view.begin_edit()
        self.view.sel().clear()
        self.view.set_syntax_file("Packages/agst3/ag.tmLanguage")
