...
from agst3.androguard.core.bytecodes.dvm_permissions import DVM_PERMISSIONS
from agst3.androguard.core.analysis.risk import PERMISSIONS_RISK, INTERNET_RISK, PRIVACY_RISK, PHONE_RISK, SMS_RISK, MONEY_RISK
from agst3.androguard.core.analysis.analysis import PathVar, TAINTED_PACKAGE_CREATE
...
class GVMAnalysis :
    ...
    def print_paths(self, class_name, method_name, descriptor) :
        ...
        for path in paths :
            ...
            print("\t", end=' ')
            for p in path[:-1] :
                print(self.nodes_id[ p ].label, "-->", end=' ')
